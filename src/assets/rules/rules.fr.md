...
## Championnat de cyclisme virtuel sur Zwift
...
La compétition est organisée par le **Comité des Jeux de la Francophonie**.
...
## 3. Comptes et équipements obligatoires

Les éléments suivants sont **obligatoires** pour participer :

- Compte **ZwiftPower** (profil public)
...
## 6. Matériel et paramètres de course

Les paramètres de course sont les suivants :

- **Vélos Zwift non neutralisés**
- **Power-ups activés**, adaptés au parcours
...
La double capture est **obligatoire** :
- pour les **trois premiers** du classement général **Catégorie 1**,
- pour le **vainqueur de chaque étape Catégorie 1**.

Elle doit être transmise dans un **délai de 24 heures**.

---

## 8. Analyses

L’organisation se réserve le droit de :
- procéder à des **analyses de performances**,
- demander toute **information complémentaire** jugée nécessaire.

---

## 9. Étapes

La liste des étapes est définie en **Annexe C** et dans le **Roadbook officiel** :

- Contre-la-montre individuel
- Étape **Uni-Puerto (After Party)** avec difficulté finale courte
- Critérium sur plusieurs tours
- Parcours vallonné
...
## Annexe A – Équipements approuvés

Tout l’équipement doit :
- être **bien entretenu**,
- utiliser la **dernière version du firmware**.
...
## Annexe B – Contrôle du poids (obligatoire)

### 1. Principe

Afin de garantir l’équité et la transparence, **tous les participants** doivent fournir une **vidéo de pesée** avant le début de la compétition.

👉 **Aucune participation ne sera possible sans validation de cette vidéo.**

---

### 2. Quand la vidéo est demandée
...
### 3. Comment faire la vidéo

La vidéo doit être :
- continue,
- sans montage,
- le participant doit être identifiable,
- le poids doit être clairement visible.

#### Option 1 – Sans miroir

1. Lancer l’enregistrement vidéo.
2. Filmer brièvement le visage du participant.
3. Orienter la caméra vers la balance.
4. Monter sur la balance.
5. Montrer tout le corps sur la balance ou, a minima, la main libre posée sur la poitrine ou le ventre.
6. Approcher la caméra afin que le poids soit clairement visible.
7. Maintenir l’affichage visible pendant quelques secondes.
8. Arrêter l’enregistrement.

#### Option 2 – Avec miroir

1. Placer la balance devant un miroir.
2. Lancer l’enregistrement vidéo.
3. Filmer le miroir afin que le participant soit visible.
4. Monter sur la balance.
5. Zoomer ou approcher la caméra pour rendre le poids lisible.
