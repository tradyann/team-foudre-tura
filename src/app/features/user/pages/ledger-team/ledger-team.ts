...
@Component({
  selector: 'app-ledger-team',
  imports: [CommonModule],
  templateUrl: './ledger-team.html',
  styleUrl: './ledger-team.css'
})
export class LedgerTeam {
  ...
  pageNumber = signal<number>(1);   // 0,1,2,...
  ...
  load() {
    ...
    this.gamingService.teamLedgerHistory(
      start.toUTCString(), 
      end.toUTCString(),
      (this.pageNumber() - 1),
      this.rowsPerPage()
